...
export async function requestPasswordReset(
  ...
  // OBS: bruger Supabases indbyggede (gratis) mailtjeneste – skabelonen kan
  // først tilpasses til et mailscanner-robust flow, når custom SMTP er sat
  // op (Supabase-krav). Indtil da bruges standard-linket via /auth/callback,
  // som i sjældne tilfælde kan blive "brugt op" af mailscannere (Outlook
  // Safe Links, Gmail m.fl.), før brugeren selv klikker. Kendt, accepteret
  // begrænsning – bed brugeren om et nyt link, hvis det sker.
